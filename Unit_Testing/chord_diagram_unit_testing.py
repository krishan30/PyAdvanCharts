...
class ChordTestCase(unittest.TestCase):
    ...
    def test_change_title_empty(self):
        ...
        self.assertEqual(chord_diagram.change_tittle(""), False)

    def test_change_title(self):
        chord_diagram = cc.ChordChart("../csv_samples/data2.csv")
        self.assertEqual(chord_diagram.change_tittle("Chord Chart"), True)
    ...
    def test_change_attribute_colour_map(self):
        chord_diagram = cc.ChordChart("../csv_samples/data2.csv")
        self.assertEqual(chord_diagram.change_attribute_colour_map(1), 'plasma')
