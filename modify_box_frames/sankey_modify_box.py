...
def get_sankey_modify_box(root, root_parent, sankey_diagram, right_frame_width):
    ...
    def regenerate_graph():
        ...
        SankeyModify.get_frame(root_parent, sankey_diagram, right_frame_width)
    ...
    block_color_btn = customtkinter.CTkOptionMenu(master=modify_frame,
                                                  values=["hls", "Paired", "Set2", "tab10", "husl", "rocket", "mako",
                                                          "flare", "crest", "magma", "viridis", "magma"],
    ...
    node_vertical_margin_label = customtkinter.CTkLabel(master=modify_frame, text="Node vertical margin :   " + str(
        float(round(block_v_m, 3))))
    ...
    node_horizontal_margin_label = customtkinter.CTkLabel(master=modify_frame,
                                                          text="Node horizontal margin :   " + str(block_h_m))
    ...
    alpha_label = customtkinter.CTkLabel(master=modify_frame,
                                         text="Label Alpha :   " + str(float(round(block_alpha, 3))))
    ...
    alpha_strip = customtkinter.CTkLabel(master=modify_frame,
                                         text="Strip Alpha :   " + str(float(round(strip_alpha, 3))))
